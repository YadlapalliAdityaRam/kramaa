...
const expansionAlgorithms = [
    ...
    },
    {
        ...
        description: 'Moves one pointer from the left and one from the right of a sorted array to find a target pair without checking every combination.',
        timeComplexity: { best: 'O(n)', average: 'O(n)', worst: 'O(n)' },
        spaceComplexity: 'O(1)',
    ...
    },
    {
        ...
        description: 'Moves a fixed-size window across an array and updates the running result by adding the new element and removing the old one.',
        timeComplexity: { best: 'O(n)', average: 'O(n)', worst: 'O(n)' },
        spaceComplexity: 'O(1)',
