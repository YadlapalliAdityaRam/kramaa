...
const LoaderOverlay = ({ visible = true, message = 'Preparing workspace' }) => {
    ...
    return (
        ...
        >
            ...
            {/* This entry layer owns the panel transform; every ring remains on its own child layer and can spin concurrently. */}
            <div className="loader-overlay-entry relative z-10">
                <div className="loader-overlay-panel flex flex-col items-center gap-5 px-8 py-7">
